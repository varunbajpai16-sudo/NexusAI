...
export default function NexusAbout() {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden selection:bg-red-500/30 selection:text-red-200">
      ...
      <nav className="relative z-20 h-[72px] border-b border-white/[0.06] bg-black/70 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto h-full px-5 md:px-8 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-zinc-950 via-black to-red-950/60 border border-red-500/25 flex items-center justify-center shadow-[0_0_25px_-7px_rgba(244,63,94,0.7)]">
              <NexusLogo size={27} />
            </div>
          ...
          <a
            href="/chat"
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-gradient-to-r from-red-600 to-pink-600 text-xs font-semibold shadow-[0_0_25px_-10px_rgba(244,63,94,0.8)] hover:scale-[1.02] transition"
          >
      ...
      <main className="relative z-10">
        <section className="max-w-5xl mx-auto px-5 md:px-8 pt-20 md:pt-28 pb-24 text-center">
          <div className="flex justify-center mb-7">
            <div className="relative">
              <div className="absolute inset-[-30px] rounded-full bg-red-500/10 blur-3xl" />
              <div className="relative w-24 h-24 rounded-[30px] bg-gradient-to-br from-zinc-950 via-[#090909] to-red-950/70 border border-red-500/30 flex items-center justify-center shadow-[0_0_70px_-15px_rgba(244,63,94,0.8)]">
          ...
          <p className="max-w-2xl mx-auto mt-6 text-sm md:text-base leading-7 text-zinc-500">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-9">
            <a
              href="/chat"
              className="flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-red-600 to-pink-600 text-sm font-semibold shadow-[0_0_35px_-12px_rgba(244,63,94,0.8)] hover:scale-[1.02] transition"
            >
              Start with Nexus <ArrowRight size={15} />
            </a>
            <a
              href="/agents"
              className="flex items-center gap-2 px-5 py-3 rounded-xl border border-white/[0.08] bg-white/[0.025] text-sm text-zinc-400 hover:text-white hover:bg-white/[0.05] transition"
            >
          ...
          <div className="grid lg:grid-cols-[1fr_1.25fr] gap-5">
            <div className="rounded-3xl border border-white/[0.07] bg-white/[0.025] p-7 md:p-9">
              ...
              <div className="mt-7 flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-red-500/10 border border-red-500/10 flex items-center justify-center text-red-400">
            ...
            <div className="relative rounded-3xl border border-white/[0.07] bg-[#080808] p-7 md:p-9 overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(244,63,94,0.08),transparent_45%)]" />
              <div className="relative">
                <div className="text-[10px] uppercase tracking-[0.2em] text-zinc-700 mb-7">
                  How Nexus thinks
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-red-600 to-pink-600 flex items-center justify-center shadow-[0_0_40px_-10px_rgba(244,63,94,0.8)]">
                    <NexusLogo size={34} />
                  </div>
                  <div className="w-px h-8 bg-gradient-to-b from-red-500/50 to-white/10" />
                  <div className="px-5 py-3 rounded-xl border border-red-500/20 bg-red-500/[0.06] text-xs text-red-300">
                    Nexus Orchestrator
                  </div>
                  <div className="w-px h-8 bg-gradient-to-b from-red-500/40 to-white/10" />
                  <div className="grid grid-cols-3 gap-2 w-full">
                    {[
                      ...
                      <div
                        key={name}
                        className="p-3 rounded-xl border border-white/[0.06] bg-white/[0.025] text-center"
                      >
                        <Icon size={16} className="mx-auto text-pink-400" />
                        <p className="text-[10px] text-zinc-500 mt-2">{name}</p>
                      </div>
                    ))}
                  </div>
                  <div className="w-px h-8 bg-gradient-to-b from-white/10 to-pink-500/30" />
                  <div className="px-5 py-3 rounded-xl border border-white/[0.06] bg-white/[0.025] text-xs text-zinc-400">
                    Unified response
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-5 md:px-8 py-24">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {principles.map(([Icon, title, description], index) => (
                <div
                  key={title}
                  className="p-6 rounded-2xl border border-white/[0.06] bg-black/30 hover:border-red-500/20 transition"
                >
                  ...
                  <h3 className="text-sm font-semibold text-zinc-200 mt-6">
                    {title}
                  </h3>
        ...
        <section className="max-w-5xl mx-auto px-5 md:px-8 pb-24">
          <div className="relative overflow-hidden rounded-3xl border border-red-500/15 bg-gradient-to-br from-red-500/[0.09] via-white/[0.025] to-pink-500/[0.05] p-8 md:p-12 text-center">
            <div className="absolute left-1/2 top-[-140px] -translate-x-1/2 w-[450px] h-[300px] rounded-full bg-red-500/[0.08] blur-[100px]" />
            <div className="relative">
              <div className="w-12 h-12 mx-auto rounded-2xl bg-gradient-to-br from-red-600 to-pink-600 flex items-center justify-center shadow-[0_0_35px_-10px_rgba(244,63,94,0.8)]">
                <NexusLogo size={26} />
              </div>
              ...
              <a
                href="/chat"
                className="inline-flex items-center gap-2 mt-7 px-5 py-3 rounded-xl bg-gradient-to-r from-red-600 to-pink-600 text-sm font-semibold shadow-[0_0_35px_-12px_rgba(244,63,94,0.8)] hover:scale-[1.02] transition"
              >
